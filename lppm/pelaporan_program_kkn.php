                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        include '../koneksi.php';
                                        $a = 1;
                                        // $data = mysqli_query($koneksi, "SELECT * FROM kkn LEFT JOIN pg ON kkn.id_pg = pg.id_pg LEFT JOIN kecamatan ON kkn.id_kec = kecamatan.id_kec LEFT JOIN kelurahan ON kecamatan.id_kec = kelurahan.id_kec LEFT JOIN potensi ON kelurahan.id_kel = potensi.id_kel LEFT JOIN subpotensi ON potensi.id_potensi = subpotensi.id_potensi JOIN user on user.id_user=pg.id_user WHERE kelurahan.id_kel != 0 and user.id_user='".$_SESSION['id_user']."'");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <!-- menampilkan format d/m/y -->
                                                <td>
                                                    <?php echo date('d-m-Y', strtotime($d['tgl_awal'])); ?>
                                                </td>
                                                <td>
                                                    <?php echo date('d-m-Y', strtotime($d['tgl_akhir'])); ?>
                                                </td>
                                                <td>
                                                    <?php echo $d['nama_kec']; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php echo $d['nama_potensi']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $d['nama_subpotensi']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $d['file']; ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a id="tombolDetail" data-toggle="modal" data-target="#detailModal<?php echo $d['id_kkn']; ?>" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt-cutoff" viewBox="0 0 16 16">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="<?php echo "files/" . $d['file'] ?>" class="btn btn-info" target="_BLANK"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="modal-detail">
                                    ...
                                    <div class="row justify-content-start">
                                        ...
                                        <div class="col-2"> : </div>
                                        <div class="col-4"> <span>
                                                <?php echo $c['app_bappeda']; ?>
                                            </span> </div>
                                    </div>
                                    <div class="row justify-content-start">
                                        <div class="col-4">Proses </div>
                                        <div class="col-2"> : </div>
                                        <div class="col-4"> <span>
                                                <?php echo $c['proses']; ?>
                                            </span> </div>
                                    ...
                                    <div class="row justify-content-start">
                                        ...
                                        <iframe src="<?php echo $sumberFile; ?>" height="450px" width="490px"></iframe>
                                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="row justify-content-start">
                                            <div class="col-4">Subpotensi yang Dipilih </div>
                                            <div class="col-2"> : </div>
                                            <div class="col-4"> <span>
                                                    <?php echo $c['nama_subpotensi']; ?>
                                                </span> </div>
                                        </div>
                                        <div class="row justify-content-start">
                                            <div class="col-4">Status </div>
                                ...
                                if (isset($_POST['tbh_file'])) {
                                    ...
                                    if ($imageFileType === "pdf") {
                                        ...
                                        if ($size < $max_size) {
                                            ...
                                            $i = mysqli_query($koneksi, "UPDATE kkn SET file= '$file' WHERE id_kkn='$id_kkn'");
                                            if ($i) {
                                                echo "<script>alert('File Berhasil Dimasukan!')</script><meta http-equiv='refresh' content='2;url=pelaporan_program_kkn.php'>";
                                            } else {
                                                echo "<script>alert('Maaf, tunggu 30 detik');</script>";
                                            }
                                        } else {
                                            echo "<script>alert('Maaf, Ukuran file dibawah  5 MB ');</script>";
                                        }
                                    } else {
                                        echo "<script>alert('Maaf, harus pdf');</script>";
                                    }
                                }
