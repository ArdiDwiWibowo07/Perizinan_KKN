        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Potensi</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        include '../koneksi.php';
                                        $a = 1;
                                        $data = mysqli_query($koneksi, "SELECT * FROM kecamatan INNER JOIN kelurahan ON kecamatan.id_kec = kelurahan.id_kec INNER JOIN potkel ON kelurahan.id_kel = potkel.id_kel INNER JOIN potensi ON potensi.id_potensi = potkel.id_potensi INNER JOIN subpotensi ON potkel.id_potkel = subpotensi.id_potkel;");
