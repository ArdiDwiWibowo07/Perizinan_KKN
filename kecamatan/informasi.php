        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-3 text-gray-800"><strong>DAFTAR INFORMASI KKN</strong> </h1>
                        ...
                        <div class="card-header py-3">
                            <div class="form-group">
                                ...
                                <select name="kelurahan" id="kelurahan" class="form-control">
                                    ...
                                    $data = mysqli_query($koneksi, "SELECT * FROM kelurahan JOIN kecamatan on kelurahan.id_kec = kecamatan.id_kec JOIN user ON kecamatan.id_user = user.id_user WHERE id_kel != 0 AND user.id_user = '$idUser'");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <option value="<?php echo $d['id_kel']; ?>"><?php echo $d['nama_kel']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
