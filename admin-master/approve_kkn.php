        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-3 text-gray-800"><strong>PERSETUJUAN KKN</strong> </h1>
                                ...
                                <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="diterima.php?id=<?php echo $d['id_kkn']; ?>">
                                                    <button class="btn btn-success">Diterima</button>
                                                </a>
                                                <a href="ditolak.php?id=<?php echo $d['id_kkn']; ?>">
                                                    <button class="btn btn-danger">Ditolak</button>
                                                </a>
                                                <a id="tombolEdit" data-toggle="modal" data-target="#editModal" data-id="<?php echo $d['id_kkn']; ?>">
                                                    <button class="btn btn-warning">Tanggal Keluar</button>
                                                </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel">Edit Surat KKN </h5>
                                </div>
                                <div class="modal-body" id="modal-edit">
                                    <form id="form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_keluar" class="form-control" id="tgl_keluar" required>
                                        </div>
