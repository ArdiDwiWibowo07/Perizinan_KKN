        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid vh-100">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-3 text-gray-800"><strong>KONTAK PERSON</strong></h1>
                    <form action="proses-kirim-kontak.php" method="post">
                        <div class="form-group">
                            <label for="telepon">Telepon :</label>
                            <input type="text" name="telepon" class="form-control" placeholder="Masukan telepon (Bisa lebih dari 1)" id="email">
                        </div>
                        <div class="form-group">
                            <label for="sosial">Sosial Media:</label>
                            <input type="text" name="sosial" class="form-control" placeholder="Masukan Sosial Media (Bisa lebih dari 1)" id="email">
                        </div>
