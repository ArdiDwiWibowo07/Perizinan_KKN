...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="Formulir_kelurahan.php">
                    <i class="fas fa-fw fa-table"></i>
	...
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="proses-update-capaian.php">
			<table>
                ...
                <tr>
					<td>Potensi</td>
					<td><input type="text" name="nama_potensi" value="<?php echo $d['nama_potensi']; ?>"></td>
				</tr>
				<tr>
					<td>Subpotensi</td>
					<td><input type="text" name="nama_subpotensi" value="<?php echo $d['nama_subpotensi']; ?>"></td>
				</tr>
                <tr>
					<td>Tanggal Awal</td>
                ...
                <tr>
					<td>Status</td>
					<td><input type="text" name="status" value="<?php echo $d['app_bappeda']; ?>"></td>
				</tr>
				<tr>
					<td>Capaian</td>
					<td><input type="text" name="capaian" value="<?php echo $d['capaian']; ?>"></td>
				</tr>
				<tr>
					<td></td>
